;;; songuo-emacs24.el --- A dark theme from Manoj
...
(custom-theme-set-faces
 ...
 '(fringe ((t (:background "darkgreen" :foreground "Wheat"))))
 ...
 '(hl-line  ((t (:background "SaddleBrown" :foreground "Old Lace"))))
 ...
 '(paren-match-face ((t (:bold t :background "blue" :foreground "red"))))
...
(provide-theme 'songuo-emacs24)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; songuo-emacs24.el ends here
